...
read_make_pkl("saved_objs/xgb_100k_estimators_preds_2008.pkl",
              xgb_preds_2008)
read_make_pkl("saved_objs/xgb_100k_estimators_preds_2012.pkl",
              xgb_preds_2012)
...
def main(argv):
    try:
        ...
        print 'xgb_100000_estimators.py [-o [2008] [2012]]'
        sys.exit(2)
    for opt, arg in opts:
        if opt == '-h':
            print 'xgb_100000_estimators.py [-o [2008] [2012]]'
